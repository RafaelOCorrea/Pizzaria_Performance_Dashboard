...
# CORREÇÃO: Tratar NaNs na coluna de Categoria antes de gerar o filtro
categorias_limpas = df_sales['Categoria Pizza'].fillna('Não Categorizado').unique()

# Obtém a lista única de categorias e adiciona a opção 'Todas'
...
if categoria_selecionada != 'Todas':
    # Filtrar o DataFrame de vendas 
    df_sales_filtered = df_sales[df_sales['Categoria Pizza'] == categoria_selecionada].copy()
else:
    # Se 'Todas' for selecionado, usa o DataFrame completo
...
# OBS: Mesmo filtrado, este gráfico mostra as categorias dentro do filtro
